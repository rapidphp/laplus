...
class ResourcesTest extends TestCase
{
    ...
    public function test_fixed_resource()
    {
        ...
        $this->assertSame('Dev', $resolved[0]->devMigrationsPath);
    ...
    public function test_modular_resource()
    {
        ...
        $this->assertSame(__DIR__ . '/Modules/Bar/Dev', $resolved[0]->devMigrationsPath);
        ...
        $this->assertSame(__DIR__ . '/Modules/Foo/Dev', $resolved[1]->devMigrationsPath);
