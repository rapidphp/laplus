...
class BelongsToManyAttr extends Attribute implements RelationAttr
{
    ...
    public function docblock(GuideScope $scope): array
    {
        ...
        $doc[] = sprintf("@method %s<%s> %s()", $scope->typeHint(BelongsToMany::class), $scope->typeHint($this->related::class), $this->name);
